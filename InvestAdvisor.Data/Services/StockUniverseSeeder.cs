    ...
    ILogger<StockUniverseSeeder>? logger = null) : IStockUniverseSeeder
{
    ...
    [
        ...
        // --- Expanded US large/mid-caps (more candidates → more setups on any given day) ---
        ("GOOG", "Alphabet Inc. (C)", "Technology"), ("ADBE", "Adobe Inc.", "Technology"),
        ("CSCO", "Cisco Systems Inc.", "Technology"), ("TXN", "Texas Instruments", "Technology"),
        ("INTU", "Intuit Inc.", "Technology"), ("NOW", "ServiceNow Inc.", "Technology"),
        ...
        ("KLAC", "KLA Corp.", "Technology"), ("PANW", "Palo Alto Networks", "Technology"),
        ("CRWD", "CrowdStrike", "Technology"), ("SNOW", "Snowflake", "Technology"),
        ("NET", "Cloudflare", "Technology"), ("DDOG", "Datadog", "Technology"),
        ("SHOP", "Shopify (US)", "Technology"), ("ABNB", "Airbnb", "Consumer"),
        ("PYPL", "PayPal Holdings", "Financials"), ("SOFI", "SoFi Technologies", "Financials"),
        ("HOOD", "Robinhood Markets", "Financials"), ("DELL", "Dell Technologies", "Technology"),
        ("ON", "ON Semiconductor", "Technology"), ("MCHP", "Microchip Technology", "Technology"),
        ("ARM", "Arm Holdings", "Technology"), ("MSTR", "MicroStrategy", "Technology"),
        ("RBLX", "Roblox", "Communication"), ("SNAP", "Snap Inc.", "Communication"),
        ("ROKU", "Roku Inc.", "Communication"), ("DASH", "DoorDash", "Consumer"),
        ("HD", "Home Depot", "Consumer"), ("LOW", "Lowe's", "Consumer"),
        ("NKE", "Nike Inc.", "Consumer"), ("MCD", "McDonald's", "Consumer"),
        ("SBUX", "Starbucks", "Consumer"), ("COST", "Costco", "Consumer"),
        ("WMT", "Walmart", "Consumer"), ("TGT", "Target", "Consumer"),
        ("LULU", "Lululemon", "Consumer"), ("CMG", "Chipotle", "Consumer"),
        ("BKNG", "Booking Holdings", "Consumer"), ("MAR", "Marriott", "Consumer"),
        ("GM", "General Motors", "Consumer"), ("F", "Ford Motor", "Consumer"),
        ("NFLX", "Netflix", "Communication"), ("WFC", "Wells Fargo", "Financials"),
        ("GS", "Goldman Sachs", "Financials"), ("MS", "Morgan Stanley", "Financials"),
        ("V", "Visa Inc.", "Financials"), ("MA", "Mastercard", "Financials"),
        ("AXP", "American Express", "Financials"), ("C", "Citigroup", "Financials"),
        ("SCHW", "Charles Schwab", "Financials"), ("BLK", "BlackRock", "Financials"),
        ("SPGI", "S&P Global", "Financials"), ("KKR", "KKR & Co.", "Financials"),
        ("UNH", "UnitedHealth", "Healthcare"), ("JNJ", "Johnson & Johnson", "Healthcare"),
        ("PFE", "Pfizer", "Healthcare"), ("MRK", "Merck & Co.", "Healthcare"),
        ("ABBV", "AbbVie", "Healthcare"), ("TMO", "Thermo Fisher", "Healthcare"),
        ("ABT", "Abbott Labs", "Healthcare"), ("BMY", "Bristol-Myers Squibb", "Healthcare"),
        ("GILD", "Gilead Sciences", "Healthcare"), ("AMGN", "Amgen", "Healthcare"),
        ("CVS", "CVS Health", "Healthcare"), ("MRNA", "Moderna", "Healthcare"),
        ("CAT", "Caterpillar", "Industrials"), ("GE", "GE Aerospace", "Industrials"),
        ("HON", "Honeywell", "Industrials"), ("UPS", "United Parcel Service", "Industrials"),
        ("RTX", "RTX Corp.", "Industrials"), ("DE", "Deere & Co.", "Industrials"),
        ("LMT", "Lockheed Martin", "Industrials"), ("COP", "ConocoPhillips", "Energy"),
        ("SLB", "Schlumberger", "Energy"), ("OXY", "Occidental Petroleum", "Energy"),
        ("MPC", "Marathon Petroleum", "Energy"), ("PSX", "Phillips 66", "Energy"),
        ("T", "AT&T Inc.", "Communication"), ("VZ", "Verizon", "Communication"),
        ("CMCSA", "Comcast", "Communication"), ("KO", "Coca-Cola", "Staples"),
        ("PEP", "PepsiCo", "Staples"), ("PG", "Procter & Gamble", "Staples"),
        // More liquid ETFs
        ("DIA", "SPDR Dow Jones", "Broad market"), ("XLK", "Technology SPDR", "Technology"),
        ("XLF", "Financials SPDR", "Financials"), ("XLE", "Energy SPDR", "Energy"),
        ("XLV", "Health Care SPDR", "Healthcare"), ("ARKK", "ARK Innovation", "Innovation"),
        ("GLD", "SPDR Gold Shares", "Gold"),
        // --- Expanded TSX large/mid-caps (.TO) ---
        ("NA.TO", "National Bank of Canada", "Financials"), ("IFC.TO", "Intact Financial", "Financials"),
        ("GWO.TO", "Great-West Lifeco", "Financials"), ("BN.TO", "Brookfield Corp.", "Financials"),
        ("BAM.TO", "Brookfield Asset Mgmt", "Financials"), ("CSU.TO", "Constellation Software", "Technology"),
        ("TRI.TO", "Thomson Reuters", "Technology"), ("GIB.A.TO", "CGI Inc.", "Technology"),
        ("ATD.TO", "Alimentation Couche-Tard", "Consumer"), ("DOL.TO", "Dollarama", "Consumer"),
        ("L.TO", "Loblaw", "Staples"), ("QSR.TO", "Restaurant Brands", "Consumer"),
        ("MG.TO", "Magna International", "Consumer"), ("WSP.TO", "WSP Global", "Industrials"),
        ("T.TO", "Telus", "Communication"), ("RCI.B.TO", "Rogers Communications", "Communication"),
        ("POW.TO", "Power Corp.", "Financials"), ("IMO.TO", "Imperial Oil", "Energy"),
        ("PPL.TO", "Pembina Pipeline", "Energy"), ("TOU.TO", "Tourmaline Oil", "Energy"),
